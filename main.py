...
def main():
    ...
    corda_loss_list, corda_time = train_with_checkpoints(model, adapter_optimizer, get_batch, device, num_iters=FINE_TUNE_ITERS, context_window_size=SEQ_LEN, eval_interval=10, checkpoint_dir=os.path.join("checkpoints", "corda"))
    ...
    full_loss_list, full_time = train_with_checkpoints(full_model, full_optimizer, get_batch, device, num_iters=FINE_TUNE_ITERS, context_window_size=SEQ_LEN, eval_interval=10, checkpoint_dir=os.path.join("checkpoints", "full"))
